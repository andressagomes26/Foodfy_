...
O Foodfy é um site criado para uma empresa fictícia de culinária, na qual é dividido em páginas contendo a página inicial, informações sobre a empresa, as principais receita, as principais informações sobre cada uma delas, além de conter um espaço para o administrador que deseja cadastrar, editar ou excluir uma receita.
